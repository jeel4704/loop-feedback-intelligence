...
const badgeVariants: Record<NonNullable<BadgeProps["variant"]>, string> = {
  ...
  slate: "bg-slate-100 text-slate-700 ring-1 ring-inset ring-slate-200 dark:bg-dark-card dark:text-slate-350 dark:ring-slate-800/80",
  ...
  outline: "bg-white text-slate-600 ring-1 ring-inset ring-slate-200 dark:bg-dark-bg dark:text-dark-muted dark:ring-slate-800"
};
