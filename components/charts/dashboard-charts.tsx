  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 grid-cols-1 lg:grid-cols-12">
        ...
        <Card className="lg:col-span-8 border border-slate-200/80 dark:border-slate-900 shadow-sm bg-white dark:bg-dark-bg rounded-2xl">
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <div className="mt-1 flex items-center gap-4 text-xs font-semibold">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-slate-500 dark:text-dark-muted">Total Feedback</span>
                  </div>
                  {volumeData.some(d => d.negativeValue !== undefined && d.negativeValue > 0) && (
                    <div className="flex items-center gap-1.5">
                      <span className="h-2 w-2 rounded-full bg-[#f43f5e]" />
                      <span className="text-slate-500 dark:text-dark-muted">Negative Feedback</span>
                    </div>
                  )}
                </div>
              </div>
              <select 
                ...
                className="border border-slate-200 dark:border-dark-border rounded-lg text-[10.5px] font-bold px-2.5 py-1 bg-white dark:bg-dark-card text-slate-600 dark:text-slate-350 outline-none cursor-pointer hover:border-slate-300 dark:hover:border-slate-700 transition"
              >
            ...
            <div className="h-60 relative">
              {trendLoading ? (
                <div className="absolute inset-0 flex flex-col items-center justify-center space-y-3 z-10 bg-white/60 dark:bg-dark-bg/60 backdrop-blur-[1px] animate-pulse">
                  <div className="h-4 w-4 rounded-full border-2 border-indigo-500 border-t-transparent animate-spin" />
                  <p className="text-xs font-semibold text-slate-500 dark:text-dark-muted">Loading feedback analytics...</p>
                </div>
              ) : trendError ? (
            ...
            <div>
              ...
              <div className="h-44 relative flex items-center justify-center">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                  {activeSentiment ? (
                    <>
                      <span className="text-[11px] text-slate-400 dark:text-dark-muted font-extrabold uppercase tracking-wider">
                    ...
                    <>
                      ...
                      <span className="text-[10px] text-slate-400 dark:text-dark-muted font-bold tracking-wider mt-0.5">
                        TOTAL
                      </span>
                    </>
                  )}
      ...
      <Card className="border border-slate-200/80 dark:border-slate-900 shadow-sm bg-white dark:bg-dark-bg rounded-2xl">
        <CardContent className="p-6">
          ...
          <div className="mt-5 pt-4 border-t border-slate-100 dark:border-dark-border space-y-3">
            <p className="text-[10.5px] font-extrabold text-slate-400 dark:text-dark-muted uppercase tracking-wider">Top Insights</p>
            <ul className="grid gap-4 grid-cols-1 md:grid-cols-3">
              <li className="flex items-start gap-2.5 text-xs bg-slate-50 dark:bg-dark-card/30 p-3 rounded-2xl border border-slate-200/40 dark:border-dark-border/80">
                <span className="text-emerald-500 font-extrabold text-sm">↑</span>
                <div>
                  <p className="text-[10px] uppercase font-bold text-slate-400 dark:text-dark-muted">Performance</p>
                  <p className="text-slate-700 dark:text-dark-secondaryText font-semibold mt-0.5">App Performance issues decreased by 15%</p>
                </div>
              </li>
              <li className="flex items-start gap-2.5 text-xs bg-slate-50 dark:bg-dark-card/30 p-3 rounded-2xl border border-slate-200/40 dark:border-dark-border/80">
                <span className="text-blue-500 font-extrabold text-sm">↑</span>
                <div>
                  <p className="text-[10px] uppercase font-bold text-slate-400 dark:text-dark-muted">Themes</p>
                  <p className="text-slate-700 dark:text-dark-secondaryText font-semibold mt-0.5">Feature Requests increased by 23%</p>
                </div>
              </li>
              <li className="flex items-start gap-2.5 text-xs bg-slate-50 dark:bg-dark-card/30 p-3 rounded-2xl border border-slate-200/40 dark:border-dark-border/80">
                <span className="text-rose-500 font-extrabold text-sm">↓</span>
                <div>
                  <p className="text-[10px] uppercase font-bold text-slate-400 dark:text-dark-muted">Pricing</p>
                  <p className="text-slate-700 dark:text-dark-secondaryText font-semibold mt-0.5">Pricing concerns decreased by 12%</p>
                </div>
              </li>
            </ul>
          </div>
      ...
      <div className={cn(
        ...
        {/* Top Themes list */}
        <Card className={cn(
          "border border-slate-200/80 dark:border-slate-900 shadow-sm bg-white dark:bg-dark-bg rounded-2xl",
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link href="/themes" className="text-[10px] text-slate-400 dark:text-dark-muted font-bold hover:text-slate-600 dark:hover:text-slate-300">View all</Link>
            </div>
                  ...
                  return (
                    <div key={theme.name} className="space-y-1">
                      <div className="flex items-center justify-between text-xs font-semibold">
                        <span className="text-slate-700 dark:text-dark-secondaryText truncate max-w-[120px]">{theme.name}</span>
                        <span className="text-slate-400 dark:text-dark-muted text-[11px]">{pct}%</span>
                      </div>
        ...
        {showAdditionalLists && (
          ...
          <Card className="lg:col-span-5 border border-slate-200/80 dark:border-slate-900 shadow-sm bg-white dark:bg-dark-bg rounded-2xl">
            <CardContent className="p-6 flex flex-col justify-between h-full">
              <div>
                ...
                <div className="h-32 relative flex items-center justify-center">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                    {activeChannel ? (
                      <>
                        <span className="text-[10px] text-slate-400 dark:text-dark-muted font-extrabold uppercase tracking-wider max-w-[65px] truncate">
                          {activeChannel.name}
                        </span>
      ...
      {showAdditionalLists && (
        ...
        <div className="grid gap-6 grid-cols-1 lg:grid-cols-12 items-start">
          ...
          <Card className="lg:col-span-6 border border-slate-200/80 dark:border-slate-900 shadow-sm bg-white dark:bg-dark-bg rounded-2xl">
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-4">
              ...
              <div className="space-y-4">
                {recentFeedback.map((item) => (
                  <div key={item.id} className="space-y-1">
                    <p className="text-[11.5px] text-slate-700 dark:text-dark-secondaryText leading-normal line-clamp-2 font-medium">
                      "{item.content}"
                    </p>
                    <div className="flex items-center justify-between text-[10px] font-bold text-slate-400 dark:text-dark-muted">
                      <span className="bg-slate-105 dark:bg-dark-card text-slate-600 dark:text-dark-muted px-1.5 py-0.5 rounded uppercase tracking-wider text-[8px] border border-slate-200/20 dark:border-dark-border">
                        {item.source}
                      </span>
                ...
                <div className="space-y-3.5">
                  {recentActivity.map((activity) => (
                    <div key={activity.id} className="flex items-start gap-2.5 text-xs">
                      ...
                      <div>
                        <p className="text-slate-700 dark:text-dark-secondaryText font-semibold leading-normal">{activity.label}</p>
